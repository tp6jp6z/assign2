  ...
  switch (gameState){
    ...
    case GAME_RUN:
        ...
        // to meet the requirement
          ...
          //if the Position of Frog is Over...
             if (frogY< 0){
               frogY= 0;
             } else if (frogY> height-frogH){
               frogY= height-frogH;
             }
...
void keyPressed() {
    ...
    && (gameState== GAME_LOSE || gameState== GAME_WIN || gameState== GAME_START)){
      gameState = GAME_RUN;
      life=3;
      frogX = frogInitX;
      frogY = frogInitY;
